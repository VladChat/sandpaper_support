...
function loadSupportAssistantAssets() {
  ...
  if (!document.getElementById(stylesheetId)) {
    ...
    link.id = stylesheetId;
    link.rel = "stylesheet";
    link.href = "/sandpaper_support/assets/support-assistant.css?v=support-followup-resume-20260430-v1";
    document.head.appendChild(link);
  }
  ...
  return loadScript(
    ...
    return loadScript(
      ...
      "/sandpaper_support/assets/support-assistant.js?v=support-followup-resume-20260430-v1",
    );
  });
}
